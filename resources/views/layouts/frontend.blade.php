...
<html lang="zxx">
  <head>
    ...
    <!-- Google Font -->
    <link
      href="://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400;600;900&display=swap"
      rel="stylesheet"
    />
  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> Flora@gmail.com</li>
        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="header__logo">
              <a href="/"><img src="{{ asset('frontend/img/logo1.png') }}" alt="" style="border-radius: 100px ; widrh:80px ; height:80px"/></a>
            </div>
          </div>
          <div class="col-lg-6">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              <div class="footer__about__logo">
                <a href="./index.html"><img src="{{ asset('frontend/img/logo1.png') }}" alt="" style="border-radius: 100px ; widrh:80px ; height:80px"/></a>
              </div>
              <ul>
                <li>Address: 60-49 Road 11378 New York</li>
                <li>Phone: +65 11.188.888</li>
                <li>Email: Flora@gmail.com</li>
              </ul>
            </div>
          </div>
